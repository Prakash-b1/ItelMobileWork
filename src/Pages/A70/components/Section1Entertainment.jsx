    ...
    return (
        <GradientBackgroundWrapper>
            <div className='md:w-[735px] text-center md:text-left'>
                <p className='lg:text-[48px] md:text-[36px] text-[24px] font-medium text-[#0E0E0E] text-wrap'>Ample Storage for Entertainment</p>
            ...
            <div className='flex md:flex-row flex-col'>
                <div className='md:p-5 md:space-y-4 flex md:block gap-2'>
                    <p className='md:text-[36px] text-[14px] font-medium text-[#0E0E0E]'>12GB* (4GB+8GB*) RAM</p>
                    ...
                    <p className='md:text-[36px] text-[14px] font-medium text-[#0E0E0E]'>64GB/128GB/ 256GB ROM</p>
                </div>
