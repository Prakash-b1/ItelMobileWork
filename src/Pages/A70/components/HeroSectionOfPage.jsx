    ...
    return (
        <div>
            ...
            >
                ...
                <div className="md:h-[800px] h-[521px] flex flex-col md:flex-row md:justify-between">
                    <div className="flex">
            ...
            <div
                style={{
                    backgroundImage: `url('/a70/A70bannermobile.webp')`, // Default image for larger screens
            ...
            >
                ...
                <div className="w-[360px] h-[479.67px] flex flex-col md:flex-row md:justify-between">
                    <div className="flex">
                        <div className="lg:gap-16 gap-4 flex flex-col justify-center px-4 pt-14 md:pt-0 md:px-0 lg:ps-[88px]">
                            <div className="flex flex-col gap-4">
                                <div className="border-2 font-bold border-[#3A3358] text-[#3A3358] text-center rounded-full w-[156px]">
                    ...
                    <img src="/a70/HritikPhotoDashb.png" alt="A70Banner" className="h-[479.67px] w-[289.02px]" />
                </div>
            </div>
        </div>
    );
