...
import sec4Img from '../../../assets/A70/Background/A70 Security.webp'
    ...
    return (
        <GradientBackgroundWrapper paddingStart='0' padding="0">
            <div className='relative flex flex-col-reverse xl:flex-col gap-5  xl:h-[739px] overflow-hidden'>
                ...
                <div className="z-10 flex xl:justify-end justify-center text-center md:text-left md:items-start lg:py-[50px] px-[13px] py-[11px]">
                    <div className="xl:w-[458px]">
                        <p className="text-desktop/h2 md:block hidden">Hello! <br /> Hassle-free Security</p>
